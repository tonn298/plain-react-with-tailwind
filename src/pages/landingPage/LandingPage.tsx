...
export const LandingPage = () => {
  return (
    <>
      <div className=''>
        {/* floating player  */}
        <div className='absolute h-[599px] w-[430px]'>
          <div className='absolute left-0 top-0 h-[233px] w-[209px]'>
            <div className='absolute top-50% h-0.5 w-100% rotate-135 bg-line'></div>
          </div>
          <img
            className='relative -left-[8rem] top-[0.5rem] z-10 h-100% w-100%'
            src={require('../../assets/footballer.png')}
            alt='footballer'
          />
        </div>
        <Header headerMessage='athlets' className='pl-[calc(33%)]' />
        <BulletPointCard
          number='01'
          heading='CONNECTION'
          body='Connect with coaches directly, you can ping coaches to view profile.'
          className={'mt-[42px] pl-[calc(33%)]'}
        />
        <BulletPointCard
          number='02'
      ...
      <div className=''>
        {/* floating player #2 */}
        <div className='absolute right-0 h-[525px] w-[480px]'>
          <div className='z-100 absolute flex'>
            <img
          ...
          <div className='absolute bottom-[96px] left-[200px] h-[178px] w-[207px]'>
            <div className='absolute top-50% h-0.5 w-100% rotate-135 bg-line'></div>
          </div>
          <img
            className='relative -right-[8rem] top-[0.5rem] z-10 h-100% w-100%'
        ...
        <BulletPointCard
          ...
          className={'mt-[39px] pb-[51px] pl-[31px] pr-[calc(33%)]'}
        />
        <BulletPointCard
          ...
          body='Work with recruiter to increase your chances of finding
              talented athlete.'
          className={
            'bg-background-pale-purple pb-[65px] pl-[31px] pr-[calc(33%)]'
          }
        />
        <BulletPointCard
          // TODO: add translation file ?
          ...
          body='Work with recruiter to increase your chances of finding
              talented athlete '
          className={'bg-dark-blue py-[44px] pl-[31px] pr-[calc(33%)]'}
          darkColorBackground
        />
      </div>
    </>
